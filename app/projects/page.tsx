    ...
    >
      ...
      <div className="mt-3 text-center">
        ...
        <p className="md:mx-40">
          ...
          Actually, I'm working on the backend of these projects. If you want to
          know more about these projects, please contact me. I will be happy to
          share with you the progress of these projects. Please, click the
